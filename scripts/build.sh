...
swift build -c release --arch arm64 --arch x86_64 -Xswiftc -warnings-as-errors >/dev/null
...
echo "› Checking packaged-app startup"
python3 scripts/smoke-app.py "$APP_DIR"
